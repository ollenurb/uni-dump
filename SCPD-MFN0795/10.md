...
Un problema particolare delle cache soprattutto nei sistemi a multiprocessore e'
la coerenza, che viene garantita da un *protocollo di cache coherence*.
Essenzialmente un protocollo del genere si basa su due strategie:
...
operazioni che vengono fatte sulla memoria sono sequenziali. Non possono
esistere quindi due operazioni che vengono eseguite contemporaneamente.
...
multiprocessore. Ad oggi, i multiprocessori **non** sono sequenzialmente
