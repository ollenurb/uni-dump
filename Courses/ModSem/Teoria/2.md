...
* SKOS (*Simple Knowledge Organization System*) e' una raccomandazione del W3C
  per la creazione di vocabolari di vario tipo: lessici, thesauri, ecc..
...
* Con SKOS si puo':
    ...
    * Assegnare notazioni ai concetti
...
* Ogni concetto in SKOS viene identificato con un URI
    * Ad esso vengono poi associate delle *etichette lessicali*:
    ...
    * Tra di loro possono essere relazionati tramite relazioni:
        * `narrower/broader`: relazione piu' specifica/piu' generale
        * `related`: relazione generica di relazione
