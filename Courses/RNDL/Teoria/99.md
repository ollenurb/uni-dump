...
$$
\frac{\partial f}{\partial v_2} \frac{\partial v_2}{\partial v_1} \frac{\partial v_1}{\partial v_0}\quad \text{oppure} \quad
...
$$
\begin{split}
\frac{\partial f}{\partial v_0} &= \frac{\partial f}{\partial v_2} \frac{\partial v_2}{\partial v_1} \frac{\partial v_1}{\partial v_0} + \frac{\partial f}{\partial v_2} \frac{\partial v_2}{v_0}\\
&= \bar{v}_2 \frac{\partial v_2}{\partial v_1} \frac{\partial v_1}{\partial v_0} + \bar{v}_2 \frac{\partial v_2}{v_0} \\
&=  1 \cdot v_0 \cdot 1 + 1 \cdot v_1\\
& = v_0 + v_1\\
\end{split}
$$
