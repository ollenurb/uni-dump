...
Gli operatori che vanno a calcolare il gradiente sono gli operatori di
*Roberts*, che calcolano la derivata sulla direzione *diagonale*. Ad esempio,
l'operatore di Roberts per calcolare il gradiente rispetto alla diagonale in cui
ci sono valori diversi da $0$.
$$
\begin{bmatrix}
-1 & 0 \\ 
0 & 1
\end{bmatrix}
$$
È importante inoltre dire che il pixel che viene considerato ogni volta durante
