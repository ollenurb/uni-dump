function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy] = elm_spars(P, T, TV_P, TV_T, Elm_Type, NumberofHiddenNeurons, ActivationFunction, RangeTarget)
...
%%%%%%%%%%% Sparse weights 
InputWeight = randmat(NumberofHiddenNeurons,NumberofInputNeurons);
BiasofHiddenNeurons = randmat(NumberofHiddenNeurons,1);
%%%%%%%%%%% Sparse weights 
tempH = InputWeight*P;
