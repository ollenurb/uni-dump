function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy] = elm_gauss(P, T, TV_P, TV_T, Elm_Type, NumberofHiddenNeurons, ActivationFunction, RangeTarget)
...
%%%%%%%%%%% Gaussian weights 
InputWeight = sqrt(1/NumberofHiddenNeurons)*randn(NumberofHiddenNeurons,NumberofInputNeurons);    %randn: gaussian distribution
%InputWeight=0.1*sqrt(1/NumberofHiddenNeurons)*randn(NumberofHiddenNeurons,NumberofInputNeurons);    %randn: gaussian distribution
BiasofHiddenNeurons = sqrt(1/NumberofHiddenNeurons)*randn(NumberofHiddenNeurons,1);   %randn: gaussian distribution
%BiasofHiddenNeurons=0.1*sqrt(1/NumberofHiddenNeurons)*randn(NumberofHiddenNeurons,1);   %randn: gaussian distribution
%%%%%%%%%%% Gaussian weights 
tempH = InputWeight*P;
