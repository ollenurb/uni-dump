...
;(function (global, factory) {
    ...
    function hasClass(element, cls) {
        ...
        return (
            !!cls &&
            toNodes(element).some((node) => node.classList.contains(cls))
        )
    }
    ...
    function registerEvent(instance, event, key) {
        ...
        if (isArray(el)) {
            el.forEach((el2) =>
                registerEvent(instance, { ...event, el: el2 }, key)
            )
            return
        }
            ...
            },
            {
                ...
                handler(e) {
                    ...
                    if (
                        ...
                        !this.items.some(
                            (el) =>
                                active2.targetEl !== el && matches(el, ':focus')
                        )
                    ) {
                        e.preventDefault()
                    }
        ...
        events: [
            ...
            },
            {
                ...
                handler(e) {
                    ...
                    if (!this.stack && active.length) {
                        Promise.all(active.map((modal) => modal.hide())).then(
                            this.show
                        )
                        e.preventDefault()
                    } else {
            ...
            },
            {
                ...
                handler() {
                    ...
                    css(this.$el, 'zIndex', '')
                    if (
                        !active.some((modal) => modal.clsPage === this.clsPage)
                    ) {
    ...
    function transformFn(prop, el, stops) {
        ...
        if (prop === 'x' || prop === 'y') {
            ...
            transformFn2 = (stop) =>
                getUnit([stop])
                    ? toPx(stop, 'width', el, true) / el.offsetWidth
                    : stop
        }
        if (stops.length === 1) {
        ...
        methods: {
            ...
            getAdjacentSlides() {
                ...
                for (const i of [-1, 1]) {
                    ...
                    do {
                        const slide =
                            this.slides[this.getIndex(this.index + i + j++ * i)]
